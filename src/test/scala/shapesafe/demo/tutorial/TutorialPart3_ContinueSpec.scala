...
class TutorialPart3_ContinueSpec extends ShouldFailBatch.SourceSpec {
  ...
  override def groundTruth: String =
    """
      |shapesafe/demo/tutorial/TutorialPart3_Continue:169: info:       28 >< 28 >< 1
      |    data.shape.reason
      |               ^
      |shapesafe/demo/tutorial/TutorialPart3_Continue:206: info:       10
      ...
      |    output.shape.reason
      |                 ^
      |shapesafe/demo/tutorial/TutorialPart3_Continue:218: info:     ▓▒░ cannot evaluate ░▒▓
      ...
      |                  ^
      |shapesafe/demo/tutorial/TutorialPart3_Continue:218: error: ¯\_(ツ)_/¯ 3136 != 784
      |    ▓▒░ ... when proving arity ░▒▓
      |3136 == 784
      |    output2.shape.reason
      |                  ^
